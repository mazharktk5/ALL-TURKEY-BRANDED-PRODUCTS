  ...
  return (
    <>
      ...
      <div className="overflow-x-auto bg-white rounded-lg shadow-md p-4">
        ...
        {list.map((item) => (
          <div key={item._id} className="grid grid-cols-2 md:grid-cols-5 gap-4 items-center py-3 border-b text-sm">
            ...
            <button onClick={() => removeProduct(item._id)} className="text-red-600 font-bold cursor-pointer text-center">Remove</button>
          </div>
        ))}
      </div>
